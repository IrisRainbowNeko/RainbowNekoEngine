...
import torch
from rainbowneko.utils.utils import low_rank_approximate
...
class LoraBlock(PatchPluginBlock):
    ...
    def wrap_model(cls, lora_id: int, model: nn.Module, **kwargs):  # -> Dict[str, LoraBlock]:
        return super(LoraBlock, cls).wrap_model(lora_id, model, exclude_classes=(LoraBlock,), parent_block=True, **kwargs)
