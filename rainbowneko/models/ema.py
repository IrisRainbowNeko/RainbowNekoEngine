...
class ModelEMA:
    def __init__(self, parameters: Iterable[Tuple[str, torch.nn.Parameter]], decay_max=0.997, decay_factor=(1, 5),
    ...
    @torch.no_grad()
    def step(self, parameters: Iterable[Tuple[str, torch.nn.Parameter]], step: int = 0):
